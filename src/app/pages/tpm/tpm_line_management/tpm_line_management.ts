...
@Component({
    ...
    selector: 'app-tpm-line-management',
    templateUrl: './tpm_line_management.html',
    styleUrls: ['./tpm_line_management.scss']
})


export class TpmLineManagementPage implements OnInit {
